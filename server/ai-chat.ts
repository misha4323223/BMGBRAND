    ...
    try {
      ...
      if (isOneSize) {
        ...
        sizingRule =
          ...
          `- АЛГОРИТМ ДЛЯ ВЕРХА: возьми обхват груди тела покупателя. Вычти его из каждого значения в колонке "Грудь" таблицы верха. Выбери строку с НАИМЕНЬШЕЙ разницей — это и есть нужный размер верха.\n` +
          `  Пример: грудь тела 96 см, таблица: S=132, M=140, L=148 → |132-96|=36, |140-96|=44, |148-96|=52 → выбери S.\n` +
          `- АЛГОРИТМ ДЛЯ НИЗА: возьми обхват бёдер тела покупателя. Вычти его из каждого значения в колонке "Бёдра" таблицы низа. Выбери строку с НАИМЕНЬШЕЙ разницей.\n` +
          `  Пример: бёдра тела 98 см, таблица: S=116, M=120, L=124 → |116-98|=18, |120-98|=22, |124-98|=26 → выбери S.\n` +
