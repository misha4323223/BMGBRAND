...
export default function PartnerRegister() {
  ...
  return (
    <>
      <SEO
        title="Регистрация партнёра — BOOOMERANGS"
        description="Регистрация в партнёрской программе BOOOMERANGS: реферальная комиссия 15–25% и авторский мерч для артистов."
        noindex
        canonical="https://booomerangs.ru/partner"
      />

      <main className="container mx-auto px-4 pt-12 pb-12 min-h-[70vh]">
        <div className="max-w-2xl mx-auto">
          <div className="mb-6">
            <Link href="/partner" className="inline-flex items-center gap-1.5 text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors" data-testid="link-back-to-partner">
              <ArrowLeft className="w-4 h-4" />
            ...
            <p className="text-muted-foreground text-sm">
              Три шага — тип партнёрства, данные и подписание. Займёт несколько минут.
            </p>
          </div>
