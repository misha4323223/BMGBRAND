...
const BLOCK_META: Record<string, { label: string; desc: string; icon: any }> = {
  ...
  ai_block_loyalty:    { label: "Программа лояльности",      desc: "Уровни Серебро/Золото, автоматические скидки. Подключается при вопросах о скидках по сумме покупок.",       icon: Trophy },
