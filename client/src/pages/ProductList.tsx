...
export default function ProductList({ forcedCatSlug, forcedSubName, forcedSubSlug, forcedUrlSlug }: ProductListProps = {}) {
  ...
  const catalogSeoDescription = seoOverride?.description || (() => {
    ...
    if (subcategoryParam && isMerch) {
      return `Купить мерч ${subcategoryParam} — официальный магазин BMGBRAND. Футболки, худи, аксессуары. Оплата частями через Долями. Доставка по России СДЭК.`;
    }
    if (subcategoryParam) {
    ...
    <>
      ...
      {categoryParam === 'clothing' && !subcategoryParam && (
        <div className="max-w-4xl mx-auto px-4 py-12 text-zinc-500 dark:text-zinc-500">
          ...
          <p className="text-sm leading-relaxed">
            Российская одежда из Тулы с доставкой по всей России через СДЭК.
          </p>
        </div>
      )}
      ...
      {currentCategory?.slug === 'socks' && !subcategoryParam && (
        <div className="max-w-4xl mx-auto px-4 py-12 text-zinc-500 dark:text-zinc-500">
          ...
          <p className="text-sm leading-relaxed">
            Доставка по всей России через СДЭК. Производство — Россия.
          </p>
        </div>
      )}
      ...
      {categoryParam === 'accessories' && !subcategoryParam && (
        <div className="max-w-4xl mx-auto px-4 py-12 text-zinc-500 dark:text-zinc-500">
          ...
          <p className="text-sm leading-relaxed">
            Всё производится в России с вниманием к качеству материалов и деталям. Доставка по всей России через СДЭК.
          </p>
        </div>
      )}
      ...
      {categoryParam === 'merch' && !subcategoryParam && (
        <div className="max-w-4xl mx-auto px-4 py-12 text-zinc-500 dark:text-zinc-500">
          ...
          <p className="text-sm leading-relaxed">
            Весь мерч производится в России. Доставка по всей России через СДЭК.
          </p>
        </div>
      )}
