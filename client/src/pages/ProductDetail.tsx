    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-3 sm:pt-5 pb-8 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-[minmax(0,1fr)_360px] lg:gap-4 gap-6">
          ...
          {/* Details */}
          <div
            className="detail-panel flex flex-col order-1 lg:order-2 lg:sticky lg:top-[72px] lg:self-start lg:max-h-[calc(100vh-5rem)] lg:overflow-y-auto lg:bg-background/96 lg:backdrop-blur-md lg:border lg:border-border/30 lg:rounded-2xl lg:shadow-2xl lg:px-5 lg:pt-4 lg:pb-6 scrollbar-hide"
          >
