...
Тот же сценарий: `node_modules` отсутствовал после импорта из GitHub, workflow зависал. Исправлено: `npm install --include=dev`. Все секреты были добавлены заранее. Сервер подключился к YDB, загрузил 826 товаров — приложение полностью рабочее.
